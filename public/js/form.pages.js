...
$(document).ready(function() {
  ...
  $("body").on("click", "#submit2", function() {
    ...
    // }
      ...
      myAxios
        .post(API_URL + "stagelisting/hours/form2", [
          finalForm,
          updates.hours
        ])
        .then(resp => {
  ...
  $("body").on("click", "#submit3", function() {
    ...
    myAxios
      .put(API_URL + "stagelisting/social_media", smForm)
      .then(resp => {
        console.log(resp);
  ...
  $("body").on("click", "#submit5", function() {
    ...
    myAxios
      ...
      .then(resp => {
        if (delta) {
          console.log(delta)
          return myAxios.put(API_URL + "updatedescription/staged", delta)
        } else {
          return resp
        }
      })
  ...
  $("body").on("click", "#submit7", function() {
    ...
    if (trimmedFaq.length) {
      myAxios
        .put(API_URL + "stagelisting/faq", faqForm)
        .then(resp => {
          console.log(resp);
          $(form5).css("display", "none");
          $(form6).css("display", "block");
